...
- Full PHPUnit: 92 passed, 1 skipped with the bundled SQLite extension enabled (93 tests total; the opt-in local PostgreSQL concurrency test is run separately).
